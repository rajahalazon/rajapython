...
def login(username, user_password):
    try:
        db_connection = MySQLdb.connect(user='root', password='new_password', host='localhost', database='raja')
...
def register(username, user_password, name, gender):
    try:
        ...
        print(e)
    return False
register ('raja2', 12345, 'raja', 'male' )
...
#register ('rajahalazon', 'rAjajr2007', 'raja', 'male')